...
public class DarkHarvestRitual extends Spell {

    public DarkHarvestRitual(Witchcraft plugin) {
        super(plugin, "dark_harvest_ritual", "Ritual of the Dark Harvest",
                SpellCategory.CURSE,
        ...
        switch (result) {
            case SUCCESS -> {
                ...
                for (Player enemy : enemies) {
                    ...
                    enemy.sendMessage("\u00A75\u00A7cDark energy courses through you...");
                }
                caster.sendMessage("\u00A75\u00A7l" + enemies.size() + " enemies afflicted by the dark harvest!");
            ...
            case BACKFIRE -> {
                caster.addPotionEffect(new PotionEffect(PotionEffectType.MINING_FATIGUE, 400, 2));
    ...
    private void playEffects(Location center) {
        ...
        world.spawnParticle(org.bukkit.Particle.SMOKE, center.clone().add(0, 1, 0), 100, 3, 1, 3);
        world.spawnParticle(org.bukkit.Particle.FLAME, center.clone().add(0, 1, 0), 50, 2, 1, 2);
